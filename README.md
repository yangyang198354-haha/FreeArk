...
FreeArk 是一套面向智慧楼宇中央空调系统的 Web 运维管理平台。后端基于 Django 5.2 + Django Channels ASGI，前端基于 Vue 3 + Vite，通过 MQTT 实时接收 PLC 设备数据，提供系统看板、设备管理、故障管理、结露预警和方舟龙虾 AI 助手等功能。
...
| 方舟龙虾 AI 助手 | 嵌入式 AI 对话助手（OpenClaw 集成），支持推理流式输出、多会话记忆隔离、语音输入 |
