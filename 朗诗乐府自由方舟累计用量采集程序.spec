...
datas = [('C:\\Users\\yanggyan\\TRAE\\FreeArk\\resource', 'resource'), ('C:\\Users\\yanggyan\\TRAE\\FreeArk\\resource\\log_config.json', '.')]
binaries = []
...
exe = EXE(
    ...
    icon=['c:\\Users\\yanggyan\\TRAE\\FreeArk\\resource\\GUI icon.ico'],
)
