...
> **信息快照：2026-05-29（v0.6.3 部署期补 freeark-fault-consumer 与 freeark-fault-cleanup.timer）。** 带 ⚠️ 的项为易变 / 用前需实测复核。
...
本手册信息采集于 **2026-05-23（OpenClaw 集成 + ASGI 迁移完成日）**，**2026-05-29 补 `freeark-fault-consumer` 与 `freeark-fault-cleanup.timer`**（v0.6.3 部署期发现遗漏）。基础设施变更后请同步更新本文件。
