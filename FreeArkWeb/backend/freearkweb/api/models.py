...
class CustomUser(AbstractUser):
    ...
    # v1.12.0: 人格偏好，空字典=未设置→使用默认人格
    # v1.13.0: 键语义拆清为 identity(副官自称)/address(如何称呼用户)/tone(语气)；
    #          旧键 greeting_style/tone_style 由 api.persona 只读兼容（生产无存量数据）
    persona = models.JSONField(default=dict, blank=True, verbose_name='人格偏好',
                               help_text='{"identity": "智能方舟的副官", "address": "尊敬的舰长大人", "tone": ""}')
