...
from .device_name_cache import get_device_name_by_sn          # 新增（v0.6.1-FM-UX）
from .fault_consumer.constants import PRODUCT_CODE_LABELS      # 新增（v0.6.1-FM-UX）
...
class FaultEventSerializer(serializers.ModelSerializer):
    ...
    def get_device_name(self, obj):
        ...
        try:
            ...
            return None
        return get_device_name_by_sn(sn)  # None 表示 dict 未命中
