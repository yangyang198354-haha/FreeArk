# 实现计划 — v1.6.0 多图提问（Multi-Image Question）
...
**依赖**：
- `docs/architecture/v1.6.0_multi_image_question/architecture_design.md` (DRAFT, APPROVED)
- `docs/architecture/v1.6.0_multi_image_question/module_design.md` (DRAFT, APPROVED)
